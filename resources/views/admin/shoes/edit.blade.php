            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('update.shoes', $shoes->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                                @csrf

                                <input type="hidden" name="old_img" value="{{$shoes->team_image}}">
                                <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="validationCustom02" class="form-label">Photo</label>
                                                            ...
                                                            <div>
                                                                <img width="200" src="{{ asset($shoes->team_image) }}" alt="">
                                                            </div>
                                                        <div>
                                                            @error('section_image')
                                                            <span style="color:red ;">
                                            ...
                                            <button class="col-sm-3 btn btn-primary" type="submit">update Shoe
                                            </button>
                                </div>
                                </div>
