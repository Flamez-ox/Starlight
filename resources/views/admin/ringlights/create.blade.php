            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('store.ringlight') }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <button class="col-sm-3 btn btn-primary" type="submit">Insert Ringlight
                                            </button>
                                </div>
                                </div>
