        ...
        <div class="d-flex">
                                    ...
                                    <div class="dropdown d-none d-sm-inline-block">
                                        <button type="button" class="btn header-item" id="mode-setting-btn">
                                            <i data-feather="moon" class="icon-lg layout-mode-light"></i>
                                            <i data-feather="sun" class="icon-lg layout-mode-dark"></i>
                                        </button>
                                    </div>
                                ...
                                <div class="dropdown d-inline-block">
                                    ...
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img class="rounded-circle header-profile-user" src="{{asset('backend/assets/images/users/logo.jfif')}}"
                                            alt="Header Avatar">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium">Starlight</span>
