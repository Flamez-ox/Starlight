            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.solution.add') }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                             <label class="form-label" for="validationCustom01">Tittle</label>
                                                        <input type="text" class="form-control" name="tittle" id="validationCustom01" placeholder="Tittle" value="" required>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <button class="col-sm-3 btn btn-primary" type="submit">Submit solution
                                            </button>
                                </div>
                                </div>
